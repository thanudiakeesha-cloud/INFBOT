...
const handleMessage = async (sock, msg) => {
  try {
    ...
    const btnCmdMap = {
      ...
      'cmd_help': `${p}help`,
      'cmd_ping': `${p}ping`,
      // Submenu category buttons
      'mediamenu':     `${p}mediamenu`,
      'dlmenu':        `${p}mediamenu`,
      'adminmenu':     `${p}adminmenu`,
      'ownermenu':     `${p}ownermenu`,
      'aimenu':        `${p}aimenu`,
      'toolmenu':      `${p}toolmenu`,
      'toolsmenu':     `${p}toolmenu`,
      'convertermenu': `${p}convertermenu`,
      'funmenu':       `${p}funmenu`,
      'generalmenu':   `${p}generalmenu`,
